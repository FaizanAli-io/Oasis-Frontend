        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between">
                ...
                <div class="menu-right">
                    ...
                    <template v-else>
                        <RouterLink :to="{ name: 'signin' }" class="mr-4 py-4 px-6 bg-gray-600 text-white rounded-lg">
                            Sign In
                        </RouterLink>

                        <RouterLink :to="{ name: 'signup' }" class="py-4 px-6 bg-purple-600 text-white rounded-lg">
                            Sign Up
                        </RouterLink>
                    </template>
                </div>
