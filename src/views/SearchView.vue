<template>
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-3 space-y-4">
            ...
            <div v-if="users.length > 0" class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-4 gap-4">
        ...
        <!-- Right side of the screen, same as feed -->
